...
def Key_Stats(gather=["Total Debt/Equity",
    ...
    sp500_df = pd.DataFrame.from_csv('ALPHAVANTAGE-INDEX.csv', index_col = None)
    stock_df = pd.DataFrame.from_csv('stock_prices.csv', index_col = None)
    # print sp500_df['Date']
    # print stock_df['Date']
        ...
        if len(each_file) > 0:
            for file in each_file:
                ...
                try:
                    ...
                    # print each_dir, file, "value:", value_list
                    try:
                        ...
                        try:
                            ...
                            print "sp500_value exception", str(e)
                    ...
                    try:
                        ...
                        try:
                            ...
                            print "1 yr later stock exception:", str(e)
